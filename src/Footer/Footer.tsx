                        ...
                        <div className='text-lg font-semibold mb-4 text-bright-sun-400'>{item.title}</div>
                            {
                                ...
                                <div key={idx} className='cursor-pointer mb-1 text-sm text-mine-shaft-300 hover:text-bright-sun-400 hover:translate-x-2 transition duration-300 ease-in-out'>{link}</div>
                            )}
                        </div>
            )}
        </div>
