...
return (
    <>
        <div className='mt-10 pb-5'>
            ...
            <div className='flex px-16 justify-evenly items-center'>
                <div className='relative'>
                    <img className='w-[30rem]' src="/Working/Girl.png" alt="girl" />
                    <div className='w-36 flex flex-col absolute top-[15%] right-0 items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md'>
                        ...
                        <div className='text-xs font-semibold text-mine-shaft-300'>70% Completed</div>
                </div>
                </div>
